                ...
                switch (opcion)
                {
                    case "1":
                        do
                        {
                            ...
                            Console.WriteLine($"El area del Cuadrado de Lado {lado}: es {cuadrado.Area():N2}");
                    ...
                    case "3":
                        do
                        {
                            ...
                            Console.WriteLine($"El area del Circulo de Radio: {circulo.Radio} es {circulo.Area():N2}");
